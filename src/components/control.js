...
export default class Control extends Component {
  ...
  render() {
    ...
    const getBackgroundTextColor = this.getTextColor(`${background}`, '#FFFFFF', '#000000');
    const getForegroundTextColor = this.getTextColor(`${color}`, '#FFFFFF', '#000000');
    ...
    return (
      <ControlWrapper>
        ...
        <FieldWrapper>
          ...
          <Button selected style={{ marginRight: '10px' }}>Text</Button>
          <Button>Icon</Button>
        </FieldWrapper>
        <FieldWrapper>
          <SmallText>Text Size</SmallText>
          <TextSize type="text" id="textsize" name="textsize" defaultValue="16" />
          <Text bold>px</Text>
        </FieldWrapper>
        <FieldWrapper>
          ...
          <CheckboxWrapper style={{ marginRight: '30px' }}>
            ...
            <Text bold dark htmlFor="bold">Bold</Text>
          </CheckboxWrapper>
          <CheckboxWrapper>
            <input type="checkbox" id="shadow" name="shadow" />
            <Text bold dark htmlFor="shadow">Shadow</Text>
          </CheckboxWrapper>
        </FieldWrapper>
      </ControlWrapper>
    );
