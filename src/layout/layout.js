    ...
    render={data => (
      <React.Fragment>
        <Helmet>
          ...
          <meta property="og:image" content={require('!!file-loader?../images/whocanuse_600.png')} />
          ...
          <meta name="twitter:image" content={require('!!file-loader?../images/whocanuse_600.png')} />
